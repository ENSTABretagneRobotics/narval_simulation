...
/**
* This is an example simulation which use configuration files and terrain model
* supplied directly into the rtac_simulation git repository.
*
* In this specific test, the rtac_simulation is located in 'build/_deps/
*/
int main()
{
